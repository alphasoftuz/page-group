    ...
    <div class="container">
        <div class="why-grid">
            ...
            <div class="four why-card bg-blue">
                <x-data-content-tools file="why-cleanfield-4-img.html">
            ...
            <div class="five why-card bg-blue">
                <x-data-content-tools file="why-cleanfield-5-img.html">
                    <img src="https://cleanfield.ru/art/pic_hat.png" alt="image">
                </x-data-content-tools>
            ...
            <div class="six why-card bg-green">
                ...
                <x-data-content-tools file="why-cleanfield-6-img.html">
                    <img src="https://cleanfield.ru/art/pic_star.png" alt="image">
                </x-data-content-tools>
            </div>
        </div>
    </div>
